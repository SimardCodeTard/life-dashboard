...
export const POST = (req: Request) => (req.json() as Promise<CalendarSourceType>).then(serverCalendarDataService.saveNewCalendarSource).then(Response.json).catch(handleAPIError);