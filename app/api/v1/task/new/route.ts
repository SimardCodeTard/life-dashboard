...
export const POST = (req: NextRequest): Promise<Response> => parseBody<Task>(req).then(TasksDataServerService.saveTask).then(() => Response.json({success: true})).catch(handleAPIError);
